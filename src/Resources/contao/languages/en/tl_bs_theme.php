...
$GLOBALS['TL_LANG']['tl_bs_theme']['enableCaret']                   = array('Enable Caret', '<em>$enable-caret</em> || default: <strong>false</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['enableRounded']                 = array('Enable Rounded', '<em>$enable-rounded</em> || default: <strong>false</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['fontWeightNormal']              = array('Font Weight Normal', '<em>$font-weight-normal</em> || default: <strong>400</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['fontWeightLight']               = array('Font Weight Light', '<em>$font-weight-light</em> || default: <strong>300</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['fontWeightBold']                = array('Font Weight Bold', '<em>$font-weight-bold</em> || default: <strong>700</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['fontWeightBase']                = array('Font Weight Base', '<em>$font-weight-base</em> || inherit: <strong>$font-weight-normal</strong> value: <strong>400</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['headingsFontWeight']            = array('Headings Font Weight', '<em>$headings-font-weight</em> || default: <strong>500</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['headingsColor']                 = array('Headings Color', '<em>$headings-color</em> || default: <strong>#212529</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['leadFontSize']                  = array('Lead Font Size', '<em>$lead-font-size</em> || default: <strong>1.25rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['leadFontWeight']                = array('Lead Font Weight', '<em>$lead-font-weight</em> || default: <strong>300</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['smallFontSize']                 = array('Small Font Size', '<em>$small-font-size</em> || default: <strong>0.8</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['textMuted']                     = array('Text Muted', '<em>$text-muted</em> || inherit: <strong>$gray-600</strong> value: <strong>#6c757d</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingY']              = array('Input Btn Padding Y', '<em>$input-btn-padding-y</em> || default: <strong>.375rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingX']              = array('Input Btn Padding X', '<em>$input-btn-padding-x</em> || default: <strong>.75rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnLineHeight']            = array('Input Btn Line Height', '<em>$input-btn-line-height</em> || inherit: <strong>$line-height-base</strong> value: <strong>1.5</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnFocusWidth']            = array('Input Btn Focus Width', '<em>$input-btn-focus-width</em> || default: <strong>.2rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnFocusColor']            = array('Input Btn Focus Color', '<em>$input-btn-focus-color</em> || default: <strong>rgba($component-active-bg, .25)</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnFocusBoxShadow']        = array('Input Btn Focus Box Shadow', '<em>$input-btn-focus-box-shadow</em> || default: <strong>none</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingYSm']            = array('Input Btn Padding Y Small', '<em>$input-btn-padding-y-sm</em> || default: <strong>.25rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingXSm']            = array('Input Btn Padding X Small', '<em>$input-btn-padding-x-sm</em> || default: <strong>.5rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnLineHeightSm']          = array('Input Btn Line Height Small', '<em>$input-btn-line-height-sm</em> || inherit: <strong>$line-height-sm</strong> value: <strong>1.5</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingYLg']            = array('Input Btn Padding Y Large', '<em>$input-btn-padding-y-lg</em> || default: <strong>.5rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnPaddingXLg']            = array('Input Btn Padding X Large', '<em>$input-btn-padding-x-lg</em> || default: <strong>1rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnLineHeightLg']          = array('Input Btn Line Height Large', '<em>$input-btn-line-height-lg</em> || inherit: <strong>$line-height-lg</strong> value: <strong>1.5</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnBorderWidth']           = array('Input Btn Border Width', '<em>$input-btn-border-width</em> || inherit: <strong>$border-width</strong> value: <strong>1px</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnFontWeight']                 = array('Btn Font Weight', '<em>$btn-font-weight</em> || inherit: <strong>$font-weight-normal</strong> value: <strong>400</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBoxShadow']                  = array('Btn Box Shadow', '<em>$btn-box-shadow</em> || default: <strong>none</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnFocusWidth']                 = array('Btn Focus Width', '<em>$btn-focus-width</em> || inherit: <strong>$input-btn-focus-width</strong> value: <strong>.2rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnActiveBoxShadow']            = array('Btn Active Box Shadow', '<em>$btn-active-box-shadow</em> || default: <strong>none</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnDisabledOpacity']            = array('Btn Disabled Opacity', '<em>$btn-disabled-opacity</em> || default: <strong>.65</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnLinkDisabledColor']          = array('Btn Link Disabled Color', '<em>$btn-link-disabled-color</em> || inherit: <strong>$gray-600</strong> value: <strong>#6c757d</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBlockSpacingY']              = array('Btn Block Spacing Y', '<em>$btn-block-spacing-y</em> || default: <strong>.5rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBorderRadius']               = array('Btn Border Radius', '<em>$btn-border-radius</em> || inherit: <strong>$border-radius</strong> value: <strong>.25rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBorderRadiusLg']             = array('Btn Border Radius Large', '<em>$btn-border-radius-lg</em> || inherit: <strong>$border-radius-lg</strong> value: <strong>.3rem</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBorderRadiusSm']             = array('Btn Border Radius Small', '<em>$btn-border-radius-sm</em> || inherit: <strong>$border-radius-sm</strong> value: <strong>.2rem</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['dropdownLinkActiveBg']          = array('Dropdown Link Active Background Color', '<em>$dropdown-link-active-bg</em> || inherit: <strong>$component-active-bg</strong> value: <strong>theme-color("primary")</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['navLinkHeight']                 = array('Nav Link Height', '<em>$nav-link-height</em> || default: <strong>2.5rem</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['navLinkHeight']                 = array('Nav Link Height', '<em>$nav-link-height</em> || default: <strong>2.25rem</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['navbarBrandPaddingY']           = array('Navbar Brand Padding Y', '<em>$navbar-brand-padding-y</em> || default: <strong>1.3125rem</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['paginationColor']               = array('Pagination Color', '<em>$pagination-color</em> || inherit: <strong>$link-color</strong> value: <strong>theme-color("primary")</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['paginationActiveBg']            = array('Pagination Active Background Color', '<em>$pagination-active-bg</em> || inherit: <strong>$component-active-bg</strong> value: <strong>theme-color("primary")</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['paginationActiveBorderColor']   = array('Pagination Active Border Color', '<em>$pagination-active-border-color</em> || inherit: <strong>$pagination-active-bg</strong> value: <strong>theme-color("primary")</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['cardGroupMargin']               = array('Card Group Margin', '<em>$card-group-margin</em> || default: <strong>($grid-gutter-width / 2)</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['badgeFontWeight']               = array('Badge Font Weight', '<em>$badge-font-weight</em> || inherit: <strong>$font-weight-bold</strong> value: <strong>700</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['modalLg']                       = array('Modal Large', '<em>$modal-lg</em> || default: <strong>800px</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['modalMd']                       = array('Modal Medium', '<em>$modal-md</em> || default: <strong>500px</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['modalSm']                       = array('Modal Small', '<em>$modal-sm</em> || default: <strong>300px</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['alertLinkFontWeight']           = array('Alert Link Font Weight', '<em>$alert-link-font-weight</em> || inherit: <strong>$font-weight-bold</strong> value: <strong>700</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['progressFontSize']              = array('Progress Font Size', '<em>$progress-font-size</em> || default: <strong>.75rem</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['progressBarBg']                 = array('Progress Bar Background Color', '<em>$progress-bar-bg</em> || default: <strong>theme-color("primary")</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['listGroupActiveBg']             = array('List Group Active Background Color', '<em>$list-group-active-bg</em> || inherit: <strong>$component-active-bg</strong> value: <strong>theme-color("primary")</strong>');
$GLOBALS['TL_LANG']['tl_bs_theme']['listGroupActiveBorderColor']    = array('List Group Active Border Color', '<em>$list-group-active-border-color</em> || inherit: <strong>$list-group-active-bg</strong> value: <strong>theme-color("primary")</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['leadColor']                     = array('Carousel Control Icon Width', '<em>$lead-color</em> || default: <strong>inherit</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['navLinkFontWeight']             = array('Nav Link Font Weight', '<em>$nav-link-font-weight</em> || inherit: <strong>$font-weight-normal</strong> value: <strong>400</strong>');
