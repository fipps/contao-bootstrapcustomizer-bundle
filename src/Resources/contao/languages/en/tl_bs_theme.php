...
$GLOBALS['TL_LANG']['tl_bs_theme']['btnFontWeight']                 = array('Btn Font Weight', '<em>$btn-font-weight</em> || inherit: <strong>$font-weight-normal</strong> value: <strong>regular (400)</strong>');
