...
$GLOBALS['TL_LANG']['tl_bs_theme']['inputBtnFocusBoxShadow']        = array('Input Button Focus Box Shadow', '<em>$input-btn-focus-box-shadow</em> || default: <strong>0 0 0 $input-btn-focus-width $input-btn-focus-color</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['btnBoxShadow']                  = array('Button Box Shadow', '<em>$btn-box-shadow</em> || default: <strong>inset 0 1px 0 rgba($white, .15), 0 1px 1px rgba($black, .075)</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['btnActiveBoxShadow']            = array('Button Active Box Shadow', '<em>$btn-active-box-shadow</em> || default: <strong>inset 0 3px 5px rgba($black, .125)</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['paginationFocusBoxShadow']      = array('Pagination Focus Box Shadow', '<em>$pagination-focus-box-shadow</em> || inherit: <strong>$input-btn-focus-box-shadow</strong> value: <strong>$input-btn-focus-box-shadow</strong>');
