...
$GLOBALS['TL_LANG']['tl_bs_theme']['headingsColor']                 = array('Headings Color', '<em>$headings-color</em> || default: <strong>inherit</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['jumbotronBg']                   = array('Jumbotron Background Color', '<em>$jumbotron-bg</em> | inherit: <strong>$gray-200</strong> value: <strong>#e9ecef</strong>');
...
$GLOBALS['TL_LANG']['tl_bs_theme']['popoverHeaderColor']            = array('Popover Header Color', '<em>$popover-header-color</em> | inherit: <strong>$headings-color</strong> value: <strong>inherit</strong>');
